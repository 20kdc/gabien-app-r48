 ...
 */
public class RubyTable extends RubyTableR implements ITileAccess.RWBounded {
    ...
    @Override
    public void setTiletypeRaw(int cellID, int type) {
        innerTableW.set16LE(cellID, type);
    }
}
