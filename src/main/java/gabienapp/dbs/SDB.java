...
import gabienapp.schema.displays.EPGDisplaySchemaElement;
        ...
        new DBLoader(bufferedReader, new IDatabase() {
            ...
            public void execCmd(char c, String[] args) throws IOException {
                ...
                if (c == 'A') {
                    ...
                    Application.autoTiles = new ATDB(new BufferedReader(fr));
                    fr.close();
                    ...
                    if (args.length > 1) {
                        ...
                        Application.autoTiles.calculateInverseMap(new BufferedReader(fr));
                        fr.close();
                    }
                }
                if (c == 'C') {
