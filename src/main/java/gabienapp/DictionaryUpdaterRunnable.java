...
import gabienapp.schema.EnumSchemaElement;
...
public class DictionaryUpdaterRunnable implements Runnable {
    ...
    public DictionaryUpdaterRunnable(String targetDictionary, String target, IFunction<RubyIO, RubyIO> iFunction, boolean b, String ivar) {
        ...
        hash = b;
        iVar = ivar;
        Application.schemas.getSDBEntry(targetDictionary);
    }
    ...
    public void actIfRequired() {
        if (actNow) {
            ...
            RubyIO target = Application.objectDB.getObject(targ);
            if (fieldA != null)
            ...
            Application.schemas.setSDBEntry(dict, ise);
        }
    }
