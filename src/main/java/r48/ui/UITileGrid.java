...
public class UITileGrid extends UIGrid {
    ...
    public UITileGrid(StuffRenderer sr, int l, boolean at, int[] mapN, int[] mapH, String tiles, int sprScale) {
        this(sr, at ? sprScale : 0, l, !at, mapN, mapH, tiles, sprScale);
    }

    public UITileGrid(StuffRenderer sr, int l, int[] remap, int sprScale) {
