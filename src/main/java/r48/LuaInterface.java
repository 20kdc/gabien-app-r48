...
public class LuaInterface {
    ...
    public static boolean luaAvailable() {
        ...
        testObject.addIVar("@string", new RubyIO().setInternString("string"));
        RubyIO special1 = new RubyIO().setInternString("string2");
        special1.addIVar("@iv", new RubyIO().setInternString("Test"));
