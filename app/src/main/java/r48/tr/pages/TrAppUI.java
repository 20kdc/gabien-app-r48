...
public class TrAppUI extends TrPage {
    ...
    public String ie_badClipboard;
    public String ie_palAdj;
    public String ie_modified;
    public String ie_noSimpleSave;
    public String ie_autogrid;
    public String ie_hint;
    public String ie_hintDesktop;
    public String ie_hintGuarded;
    public String ie_tdFill;
    public String ie_tdEye;
    public String ie_tdLineS;
    public String ie_tdLineE;
    public String ie_tdEyePal;
    public String ie_tdFillS;
    public String ie_tdFillE;
    public String ie_autoshade;
    public String ie_autoshadeLR;
    public String ie_autoshadeUD;
    public FF1 ie_loadFail;
    public FF1 ie_saveFail;
    public String ie_indexed;
    public String ie_argb32;
    public String ie_palWarn;
    public String ie_npWarn;
    public FF1 ie_ckSetting;
    public String ie_rmWarn;
    public String ie_grid;
    public String ie_gridSize;
    public String ie_gridOffset;
    public String ie_gridColour;
    public String ie_undoNone;
    public String ie_redoNone;
    public String ie_charGen;
    public String ie_pal;
    public String ie_palAdd;
    public String ie_palChg;
    public String ie_newWarn;
    public String ie_newOk;
    public String ie_resize;
    public String ie_flipX;
    public String ie_flipY;
    public String ie_gridOverlay;
