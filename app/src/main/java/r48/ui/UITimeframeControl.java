 ...
 * Created on 2/17/17.
 */
public class UITimeframeControl extends AppUI.Prx {
    ...
    public UITimeframeControl(AppUI app, Supplier<Integer> gfi, Supplier<Integer> gfc, Consumer<Integer> sfi, int framerate) {
        super(app);
        getFrameIdx = gfi;
        getFrameCount = gfc;
        setFrameIdx = sfi;
