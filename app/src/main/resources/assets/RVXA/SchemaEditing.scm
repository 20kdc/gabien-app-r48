...
; the VX Ace SchemaEditing file

(> genericScriptParameter typeChanger{ genericScriptParametersSW [ RPG::MoveRoute oRPG::MoveRoute RPG::MoveCommand oRPG::MoveCommand RPG::BGM oRPG::BGM RPG::BGS oRPG::BGS string \" boolean T boolean F int i })
...
(e event_pritype \0 floor \1 character \2 flying)
...
(@ x int)
(@ y int)
(@ pages arrayAL1 subwindow RPG::Event::Page)

(: RPG::Map::Encounter)
(@ troop_id troop_id)
(@ weight int)
(@ region_set subwindow array \0 int)
...
(@ bgs RPG::BGS)
(+ tableD @data @width @height \3 \17 \13 \4 \2048 \0 \0 \0)
...
(e map_scroll_type \0 none \1 vertical \2 horizontal \3 both)
(@ scroll_type map_scroll_type)
(@ display_name string)
(@ encounter_list subwindow array \0 RPG::Map::Encounter)
