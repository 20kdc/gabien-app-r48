...
(obj 101 "\"Start Text\" (? ]0 \"\" \" (c.401/102/103/104)\") ($ \" w/face \" ]0) ($ \":\" ]1) (? ]2 (\" (\" (if-eq ]2 1 \"no bkg, \" \"bkg, \") (@ ]3 change_text_options_position) \")\"))")
(C category \0)
...
(obj 104 "\"Input Item\" ($ \" to \" ]0 var_id #t)")
(C category \0)
(d Lets the player choose an item... for some reason.)
(p var var_id)

(obj 105 "\"Show Scrolling Text (c.405)\"")
(C category \0)
...
(obj 125 "\"Gold\" ($ \" += \" : operate_value_0) \" Add/Remove\"")
(C category \2)
...
(obj 126 "\"Item\" ($ \" \" ]0 item_id #t) ($ \" += \" : operate_value_1) \" Add/Remove\"")
(C category \2)
...
(obj 127 "\"Weapon\" ($ \" \" ]0 weapon_id #t) ($ \" += \" : operate_value_1) \" Add/Remove\"")
(C category \2)
(d Give or take weapons from the player.)
(X weapon_add_remove_parameters)

(obj 128 "\"Armour\" ($ \" \" ]0 armour_id #t) ($ \" += \" : operate_value_1) \" Add/Remove\"")
(C category \2)
...
(obj 201 "(? ]0 (@ : transfer_player_paramassist) \"Transfer Player\")")
(C category \2)
...
(obj 202 "(? ]0 (@ : transfer_vehicle_paramassist) \"Transfer Vehicle\")")
(C category \3)
...
(obj 203 "(? ]0 (@ : set_event_location_paramassist) \"Set Event Location\")")
(C category \3)
...
(obj 211 "\"Player Opacity\" ($ \" to \" ]0)")
(C category \2)
(d Controls if the player is completely invisible or not.)
(p opaque int_boolean)

(obj 212 "\"Show\" ($ \" \" ]0 character_id) \" Anim.\" ($ \" \" ]1 animation_id) (? ]2 (\" (wait? \" (@ ]2) \")\"))")
(C category \3)
...
(obj 213 "\"Show\" ($ \" \" ]0 character_id) \" Balloon.\" ($ \" \" ]1 balloon_id) (? ]2 (\" (wait? \" (@ ]2) \")\"))")
(C category \3)
...
(obj 230 "\"Wait\" (? ]0 (\" \" (@ ]0) \" frames\"))")
(d Wait some amount of frames.)
(p timeFrames int)

(obj 231 "\"Set Picture\" ($ \" \" ]0) ($ \" to \" ]1)")
...
(obj 235 "\"Erase Picture\" ($ \" \" ]0)")
(d Get rid of a picture.)
(p id int)

(obj 236 "\"Set Weather\" ($ \" to \" ]0 weather_type)")
...
(obj 242 "\"Fadeout BGM over\" ($ \" \" ]0) \" seconds\"")
...
(obj 246 "\"Fadeout BGS over\" ($ \" \" ]0) \" seconds\"")
...
(obj 283 "\"Switch Battleback\" ($ \" to \" ]0) ($ \" \" ]1)")
(d Change the backgrounds used for battle purposes.)
(p back1 string)
(p back2 string)

(obj 284 "\"Switch Parallax\" ($ \" to \" ]0)")
(C category \3)
...
(obj 301 "\"Start Battle (c.601/602/603/604)\"")
(d Begin a battle.)
(C category \4)
...
(obj 311 "\"Actor\" ($ \" \" : iterate_actor_var) \" HP +=\" ($ \" \" : operate_value_2)")
...
(obj 312 "\"Actor\" ($ \" \" : iterate_actor_var) \" MP +=\" ($ \" \" : operate_value_2)")
...
(obj 313 "(? ]2 (if-eq ]2 0 \"Add\" \"Remove\") \"Change\") \" Actor\" ($ \" \" : iterate_actor_var #t) \" State\" ($ \" \" ]3 state_id #t)")
...
(obj 314 "\"Full recover on actor\" ($ \" \" : iterate_actor_var #t)")
...
(obj 315 "\"Actor\" ($ \" \" : iterate_actor_var) \" EXP +=\" ($ \" \" : operate_value_2)")
...
(obj 316 "\"Actor\" ($ \" \" : iterate_actor_var) \" LVL +=\" ($ \" \" : operate_value_2)")
...
(obj 317 "\"Change Actor\" ($ \" \" : iterate_actor_var) \" Parameter\" ($ \" \" ]2 cap_type) ($ \" by \" : operate_value_3)")
...
(obj 318 "(? ]2 (if-eq ]2 0 \"Add\" \"Remove\") \"Change\") \" Actor\" ($ \" \" : iterate_actor_var) \" Skill\" ($ \" \" ]3 skill_id #t)")
...
(obj 319 "\"Change Equipment on actor\" ($ \" \" ]0 actor_id)")
...
(obj 320 "\"Rename Actor\" ($ \" \" ]0 actor_id) ($ \" to \" ]1)")
...
(obj 321 "\"Change Actor\" ($ \" \" ]0 actor_id) \" Class\" ($ \" to \" ]1 class_id)")
(d Change a party member\'s class.)
(C category \2)
(p actor actor_id)
(p class class_id)

(obj 322 "\"Change Actor\" ($ \" \" ]0 actor_id) \" Sprites\"")
...
(obj 323 "\"Change Vehicle\" ($ \" \" ]0 vehicle_id) \" Graphic\"")
...
(obj 324 "\"Change\" ($ \" \" ]0 actor_id) \" Nickname\" ($ \" to \" ]1)")
(d Change the nickname of a party member. Why they have nicknames, I do not know...)
(C tag translatable)
(p actor actor_id)
(p nickname string)

(obj 331 "\"Enemy\" ($ \" \" ]0 iterate_enemy #t) \" HP +=\" ($ \" \" : operate_value_1)")
...
(obj 332 "\"Enemy\" ($ \" \" ]0 iterate_enemy #t) \" MP +=\" ($ \" \" : operate_value_1)")
