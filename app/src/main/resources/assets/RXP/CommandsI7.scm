...
(obj 331 "\"Change Enemy\" ($ \" \" ]0 iterate_enemy #t) \" HP\" ($ \" by \" : operate_value_1) (? ]4 (if-eq ]4 #t \" (can kill)\" \" (never kills)\"))")
(C category \4)
...
(obj 332 "\"Change Enemy\" ($ \" \" ]0 iterate_enemy #t) \" SP\" ($ \" by \" : operate_value_1)")
(C category \4)
(p enemyType iterate_enemy)
; operate_value
(p modNegate int_boolean)
...
(obj 335 "\"Show Enemy\" ($ \" \" ]0 troop_enemy_id #t)")
(C category \4)
(p enemy troop_enemy_id)

(obj 336 "\"Transform Enemy\" ($ \" \" ]0 troop_enemy_id #t) ($ \" into \" ]1 enemy_id #t)")
(C category \4)
(p changeling troop_enemy_id)
(p transform enemy_id)

(obj 337 "\"Show\" ($ \" \" ]0 iterate_battler0) ($ \" \" ]1 iterate_battler1) \" Battle Animation\" ($ \" \" ]2 animation_id)")
(C category \4)
(p ib0 iterate_battler0)
(p ib1 iterate_battler1)
(p animId animation_id)

(obj 338 "\"Deal\" ($ \" \" ]0 iterate_battler0) ($ \" \" ]1 iterate_battler1) \" damage\"")
(C category \4)
(p ib0 iterate_battler0)
(p ib1 iterate_battler1)
