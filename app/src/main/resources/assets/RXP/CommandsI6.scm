...
(obj 311 "\"Actor\" ($ \" \" ]0 iterate_actor #t) \" HP +=\" ($ \" \" : operate_value_1) (? ]0 (if-eq ]4 #t \" (can kill)\" \" (never kills)\"))")
(C category \2)
...
(obj 312 "\"Actor\" ($ \" \" ]0 iterate_actor #t) \" SP +=\" ($ \" \" : operate_value_1)")
...
(obj 313 "(? ]1 (if-eq ]1 0 \"Add\" \"Remove\") \"Change\") \" Actor\" ($ \" \" ]0 iterate_actor #t) \" State\" ($ \" \" ]2 state_id #t)")
...
(obj 314 "\"Full recover on actor\" ($ \" \" ]0 iterate_actor #t)")
(d Fully recovers actor/party to full health and SP.)
(C category \2)
(p actor iterate_actor)

(obj 315 "\"Actor\" ($ \" \" ]0 iterate_actor #t) \" EXP +=\" ($ \" \" : operate_value_1)")
...
(obj 316 "\"Actor\" ($ \" \" ]0 iterate_actor #t) \" LVL +=\" ($ \" \" : operate_value_1)")
...
(obj 317 "\"Change Actor\" ($ \" \" ]0 actor_id #t) \" Parameter\" ($ \" \" ]1 cap_type) ($ \" by \" : operate_value_2)")
...
(obj 318 "(? ]2 (if-eq ]2 0 \"Add\" \"Remove\") \"Change\") \" Actor\" ($ \" \" ]0 actor_id #t) \" Skill\" ($ \" \" ]3 skill_id #t)")
...
(obj 319 "\"Actor\" ($ \" \" ]0 actor_id #t) \" equips\" ($ \" \" ]1 actor_equip_type) (if-eq ]1 0 ($ \" \" ]2 weapon_id #t) ($ \" \" ]2 armour_id #t))")
...
(obj 321 "\"Reclass Actor\" ($ \" \" ]0 actor_id)  ($ \" to \" ]1 class_id)")
(d Changes the class of an actor.)
(C category \2)
(p actor actor_id)
(p newClass class_id)

(obj 322 "\"Change Actor\" ($ \" \" ]0 actor_id) \" Graphic\" ($ \" to \" ]1)")
