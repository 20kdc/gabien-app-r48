...
(cmd 125 "Modify Gold" (? ]0 (" by " (@ : operate_value_0))))
(C category 2)
...
(cmd 126 "Modify Item" (? ]0 (" " (@ ]0 item_id #t) " by " (@ : operate_value_1))))
(C category 2)
...
(cmd 127 "Modify Weapon" (? ]0 (" " (@ ]0 weapon_id #t) " by " (@ : operate_value_1))))
(C category 2)
...
(cmd 128 "Modify Armour" (? ]0 (" " (@ ]0 armour_id #t) " by " (@ : operate_value_1))))
(C category 2)
...
(cmd 133 "Change Battle End ME" ($ " to " ]0))
(C category 5)
