...
(obj 202 "(? ]0 (@ : set_event_location_paramassist) \"Set Event Location\")")
(C category \3)
...
(obj 204 "\"Change Map\" (? ]0 (\" \" (@ ]0 cms_type))) \" Settings\"")
(C category \3)
(p type cms_type)
(X change_map_settings_parameters)

(obj 205 "\"Fog Colour Tone\"")
(C category \3)
(p colour Tone)
(p duration int)

(obj 206 "\"Fog Opacity Change\"")
(C category \3)
(p opacity opacity)
(p duration int)

(obj 207 "\"Show Animation\" ($ \" on \" ]0 character_id) ($ \": \" ]1 animation_id)")
(C category \3)
(p event character_id)
(p anim animation_id)

(obj 208 "\"Set Player Opacity\"")
(C category \2)
(p opaque int_boolean)

(obj 209 "\"Set event\" ($ \" \" ]0 character_id) \" route\" ($ \" \" ]1)")
(C category \3)
(p eID character_id)
...
(obj 509 "\"(MoveRoute Editor Helper)\"")
(C category \3)
(p ex genericScriptParameter)

(obj 210 "\"Wait for move end\"")
(C category \3)

; Yes, there is a gap here.

(obj 221 "\"Prepare for transition\"")
(C category \3)

(obj 222 "\"Transition\" ($ \" \" ]0)")
(C category \3)
(p transition string)

(obj 223 "\"Change Screen Tone\"")
(C category \3)
(p tone Tone)
(p duration int)

(obj 224 "\"Screen flash\"")
(C category \3)
(p colour Color)
(p duration int)

(obj 225 "\"Screen shake\"")
(C category \3)
(p power int)
(p speed int)
(p duration int)

(obj 231 "\"Set/show picture\" ($ \" \" ]0) ($ \" to \" ]1)")
(C category \3)
(p pictureId int)
...
(obj 233 "\"Rotate picture\" ($ \" \" ]0)")
(C category \3)
(p pictureId int)
(p speed int)

(obj 234 "\"Change picture\" ($ \" \" ]0) \" tone\" ($ \" to \" ]1) ($ \" \" ]2)")
(C category \3)
(p pictureId int)
(p picTone1 Tone)
(p picTone2 int)
...
(obj 236 "\"Weather set\" ($ \" to \" ]0 weather_type)")
(C category \3)
(p type weather_type)
(p power int)
(p fadeDuration int)

(obj 241 "\"Set BGM\" ($ \" to \" ]0)")
(C category \5)
(p track rpg_audiofile_bgm)

(obj 242 "\"Fade out BGM over\" ($ \" \" ]0) \" seconds\"")
(C category \5)
(p seconds int)

; [ gap here, perfectly fine ]

(obj 245 "\"Set BGS\" ($ \" to \" ]0)")
(C category \5)
(p track rpg_audiofile_bgs)

(obj 246 "\"Fade out BGS over\" ($ \" \" ]0) \" seconds\"")
(C category \5)
(p seconds int)

(obj 247 "\"Backup BGM/BGS\"")
(C category \5)

(obj 248 "\"Start BGM/BGS from backup\"")
(C category \5)
