...
(p _ string)
(X movecommand_default_nothing)
(cmd 22 "Face Away From Player")
(d "Turn to flee the player!")
(p _ string)
(X movecommand_default_nothing)
(cmd 23 "Wait 20 Frames")
...
(cmd 33 ("Switch" (? ]1 (" " (@ ]1 switch_id #t))) " Off"))
