...
(p _ string)
(X movecommand_default_nothing)
(obj 22 "\"Face Away From Player\"")
(d Turn to flee the player!)
(p _ string)
(X movecommand_default_nothing)
(obj 23 "\"Wait 20 Frames\"")
...
(obj 33 "(\"Switch\"(? ]1(\" \"(@ ]1 switch_id #t)))\" Off\")")
