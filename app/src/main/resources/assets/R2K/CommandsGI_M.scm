...
(cmd 10830 ("Teleport Player By Vars" (? ]3 (" " (@ ]1 var_id #t) ", " (@ ]2 var_id #t) ", " (@ ]3 var_id #t)))))
(C category 3)
...
(cmd 10720 ("Show Shop" (? ]3 (": " (@ ]1 show_shop_bstype) ", message set " (@ ]2 show_shop_type)))))
(C category 0)
...
(cmd 10730 ("Show Inn" (? ]3 (" typeB: " (@ ]1) ", price: " (@ ]2) " " (if-eq ]3 0 () (" (result branch follows)"))))))
(C category 0)
...
(cmd 10740 ("Enter Party Member" (? ]1 (" " (@ ]1 actor_id #t) "'s")) " Name"))
(C category 2)
...
(cmd 10810 ("Teleport Player" (? ]3 (" to " (@ ]1 internal_mapDictionary #t) " : " (@ ]2) ", " (@ ]3) (? ]4 (" dir " (@ ]4)))))))
(C category 2)
...
(cmd 10840 "Player Enters Or Leaves Vehicle")
(C category 2)
...
(P 1 _ int_default_1)
(v 2 direction camera_pan_control_direction)
(P 1 _ int_default_1)
(v 2 distTiles int_default_1)
(P 1 _ int_default_1)
(v 2 speed int_default_1)
(v 3 speed int_default_1)
(P 1 _ int_default_1)
...
(cmd 11210 ("Show Animation" (? ]4 (" " (@ ]1 animation_id #t) " at " (@ ]2 character_id #t) (if-eq ]3 0 () (" (wait)")) (if-eq ]4 0 () (" (global)"))))))
(C category 3)
...
(cmd 11320 ("Flash Character" (? ]7 (" " (@ ]1 character_id #t) " [" (@ ]2) "," (@ ]3) "," (@ ]4) "," (@ ]5) "] for " (@ ]6) "/10 seconds" (if-eq ]7 0 () (" (wait)"))))))
(C category 3)
