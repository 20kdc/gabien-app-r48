...
(cmd 1005 ("<Battle> Call Common Event " (? ]1 ((@ ]1 commonevent_id #t) " ")) "(2k3)"))
(C category 4)
(d "Calls a common event. Not sure what else to say here.")
(p _ string)
(p cev commonevent_id)

(cmd 1006 "<Battle> Force Enemy/Player Flee (2k3)")
(C category 4)
...
(cmd 1007 "<Battle> Setup Battle Combo (2k3?)")
(C category 4)
...
(cmd 13110 "<Battle> Change Enemy HP")
(C category 4)
...
(cmd 13120 "<Battle> Change Enemy SP")
(C category 4)
...
(cmd 13130 "<Battle> Change Enemy Condition")
(C category 4)
...
(cmd 13310 "<Battle> Conditional Branch")
(C category 4)
