...
(: RPG::Actor)
(C datum \(r2k-namename\ RPG::Actor\))
...
(: RPG::Skill)
(C datum \(r2k-namename\ RPG::Skill\))
(+ rpg_skill_sect0)
...
(: RPG::Enemy)
(C datum \(r2k-namename\ RPG::Enemy\))
...
(C datum \(r2k-namename\ RPG::Troop\))
...
(: RPG::Terrain)
(C datum \(r2k-namename\ RPG::Terrain\))
(@ name string)
(@ damage int)
...
(: RPG::State)
(C datum \(r2k-namename\ RPG::State\))
(@ name stringLen \8)
...
(: RPG::Animation)
(C datum \(r2k-namename\ RPG::Animation\))
(@ name string)
...
(: RPG::Tileset)
(C datum \(r2k-namename\ RPG::Tileset\))
...
(: RPG::Class)
(C datum \(r2k-namename\ RPG::Class\))
(@ name string)
(@ dual_wield boolean)
(@ lock_equipment boolean)
(@ battle_auto boolean)
...
(C datum \(r2k-namename\ RPG::BattlerAnimation\))
...
(C datum \(r2k-namename\ RPG::BattlerAnimationSet\))
(@ name string)
