...
(obj 102 "\"Show Choices: \" (? ]0 ((@ ]0 choice_array) \" \" (if-ne ]1 0 \"(can cancel)\")) \"(c.402/403/404)\")")
(C category \0)
...
(obj 103 "\"Input Number\" ($ \" to \" ]0 var_id #t)")
(C category \0)
...
(obj 121 "\"Control Switch\" (vv= ]0 ]1 \"\" \"es\") (? ]0 (\" \" (@ ]0 switch_id #t) (vv= ]0 ]1 \"\" (\"..\" (@ ]1 switch_id #t))) \" = \" (@ ]2 int_boolean_switch_not)))")
(C category \1)
...
(obj 122 "\"Set Variable\" (vv= ]0 ]1 \"\" \"s\") (? ]0 (\" \" (@ ]0 var_id #t) (vv= ]0 ]1 \"\" (\"..\" (@ ]1 var_id #t))) \" \" (@ ]2 set_variables_operation) \" \" (@ : set_variables_parameters)))")
(C category \1)
...
(obj 123 "\"Control Selfswitch\" (? ]0 (\" \" (@ ]0 selfswitch_id) \" = \" (@ ]1 int_boolean_switch_not)))")
(C category \1)
...
(obj 111 "\"Conditional\" (? ]0 (@ : conditional_branch_parameters) \" Branch (c.411/412)\")")
(C category \1)
...
(obj 115 "\"Exit Event Processing\"")
(C category \1)
(d Stops running the code in this page.)

(obj 117 "\"Call Common Event\" ($ \" \" ]0 commonevent_id)")
(C category \1)
...
(obj 124 "(? ]0 (if-eq ]0 1 \"Stop Timer\" (\"Start Timer at \" (@ ]1) \" seconds\")) \"Start/Stop Timer\")")
(C category \5)
...
(obj 129 "(? ]0 (@ : add_remove_actor_parameters) \"Add/remove actor to party\")")
(C category \2)
...
(obj 303 "\"Input Name For Actor\" ($ \" \" ]0 actor_id #t)")
...
(obj 601 "\"Battle Result Branches Start: If Win\"")
...
(obj 602 "\"Battle Result Branch: If Escape\"")
...
(obj 603 "\"Battle Result Branch: If Lose\"")
...
(obj 604 "\"Battle Result Branches End\"")
...
(obj 333 "(? ]1 (if-eq ]1 0 \"Add\" \"Remove\") \"Change\") \" Enemy\" ($ \" \" ]0 iterate_enemy #t) \" State\" ($ \" \" ]2 state_id #t)")
...
(obj 334 "\"Enemy\" ($ \" \" ]0 iterate_enemy) \" recovers all\"")
...
(obj 340 "\"Abort Battle\"")
(C category \4)
(d Simply refuse to let the battle continue.)

(obj 351 "\"'Call Menu Screen' (aborts battle?)\"")
(C category \5)
(obj 352 "\"'Call Save Screen' (aborts battle?)\"")
(C category \5)

(obj 353 "\"Game Over\"")
(C category \5)

(obj 354 "\"Return to Title\"")
(C category \5)
