...
(obj 980 "\"Anti-Mass Spectrometer Test Fire\" (? ]0 (\": \" (@ ]0))) (? ]1 (\" on \" (@ ]1))) (? ]2 (\" and \" (@ ]2)))")
(d Test samples using Anti-Mass Spectrometer testtextteststext)
(X ams_setting_host)

(obj 985 "\"Enable big scary thing \" (if-eq ]0 #t \"now.\" \"later.\")")
...
(obj 995 "\"Long-term Plan\" (? ]1 (\" \" (@ ]0) \" \" (@ ]1 ltp_type)))")
...
(obj 998 "\"Test JSONlike Disambiguation\"")
